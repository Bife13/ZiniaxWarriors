                                              ...
                                              const FString& Options, const FString& Portal)
{
	...
	UClass* ClassToSpawn = SpawnableCharacters->FindRow<FSpawnableCharacter>(CharacterNames[3], "")->PlayableCharacter;
	if (SpawnedPlayer)
	{
		ClassToSpawn = SpawnableCharacters->FindRow<FSpawnableCharacter>(CharacterNames[3], "")->PlayableCharacter;
	}
